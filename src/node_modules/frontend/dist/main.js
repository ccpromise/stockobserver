    ...
    methods: {
        data: function (page) {
            return {
                ...
                filter: this.searchItem === '' ? {} : { secID: this.searchItem.toLowerCase() },
                sort: this.sort
            };
        },
        selectPage: function (page) {
            this.httpRequest(this.path, this.data(page), this.verb, r => {
                ...
                console.log(r);
                console.log('this.paginatedItems: ', res.data);
            });
        },
        search: function () {
            this.selectPage(1);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("show realtime simulation results")])]), _vm._v(" "), _c('div', [_c('button', {
    attrs: {
      "type": "button",
  ...
  return _c('th', [_c('button', [_vm._v("TradePlan")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
