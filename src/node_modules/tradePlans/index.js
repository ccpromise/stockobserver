...
exports.MACD = {
    '_id': 'MACD',
    'desc': 'buying when MACD was less than 0 yesterday and is bigger than 0 today. selling if opposite',
    'dpInTmpl': and([offset(gt([constant(0), macdend()], 1), -1), gt([macdend(), constant(0)], 0)], 0),
    'dpOutTmpl': and([offset(gt([macdend(), constant(0)], 0), -1), gt([constant(0), macdend()], 1)], 0)
}

exports.list = ['MACD', 'MA1060'];
