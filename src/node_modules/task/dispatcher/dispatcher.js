...
function createServer() {
    var server = http.createServer((req, res) => {
        ...
        httpPack.setResHeader('access-control-allow-headers', 'verb');
        httpPack.setResHeader('access-control-allow-method', 'GET,POST,PUT,LOCK,OPTIONS');
        httpPack.setResHeader('access-control-allow-origin', '*');
        httpPack.setResHeader('access-control-max-age', '3600');
    ...
    var loop = function() {
        setTimeout(() => {
            taskCol.find({ status: taskStatus.wait }).then((docs) => {
                ...
                console.log('find ready tasks: ', readyTaskId.length);
