...
function run() {
    ...
    var iter = function() {
        setTimeout(() => {
            postReq({ path: '/task', data: null, headers: { verb: 'dispatch' } }).then((r) => {
...
function report(result) {
    return postReq({ path: '/task', data: result, headers: { verb: 'report' } }).catch(() => {
        console.log('result is rejected by server');
    })
}
