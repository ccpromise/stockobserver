...
function downloadFromAzure(localPath, container) {
    console.log('start to download ', container, ' to local dir', localPath);
    ...
    return azure.getBlobList(container).then((list) => {
        ...
        }).then(() => console.log('complete downloading from azure. Final err list: ', remainingList));
    })
}
...
console.log('start to download blobs in ', container, ' to local directory ', local);
downloadFromAzure(local, container);
