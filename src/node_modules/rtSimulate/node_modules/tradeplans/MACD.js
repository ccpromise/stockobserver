...
// var macdTmpl = { type: 'macd', pack: { Nl: macdCoeff.Nl, Ns: macdCoeff.Ns, Na: macdCoeff.Na, pvd: '{{end}}' } };
// var ema1Tmpl = { type: 'ema', pack: { N: macdCoeff.Nl, pvd: '{{end}}' } };
// var ema2Tmpl = { type: 'ema', pack: { N: macdCoeff.Ns, pvd: '{{end}}' } };
// var difTmpl = { type: 'sub', pack: { pvds: [ema1Tmpl, ema2Tmpl], idx: 1 } };
// var deaTmpl = { type: 'ema', pack: { N: macdCoeff.Na, pvd: difTmpl } };
...
exports.getHistoryStockData = function (secID, end) {
    // console.log('1', end.get(end.maxTs));
    // var map = { end: end };
    // var macdLi = refReplace(macdTmpl, map);
    // var difLi = refReplace(difTmpl, map);
    // var deaLi = refReplace(deaTmpl, map);
    // console.log('2', macdLi.pack.pvd.get(macdLi.pack.pvd.maxTs));
    ...
    return Promise.all([macdLi, ema1Li, ema2Li, deaLi].map(makeDataPvd)).then((pvds) => {
        ...
        macd.set(secID, pvds[0].get(maxTs));
